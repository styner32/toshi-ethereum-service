...
contract NonFungibleToken {
  ...
  // perposfully broken erc721 transfer event
  event Transfer1(address indexed _from, address _to, uint256 _tokenId);
  ...
  function transfer(address _to, uint _tokenId) public onlyExtantToken(_tokenId) {
    ...
    Transfer1(msg.sender, _to, _tokenId);
  }
  ...
  function mint(address _owner, uint256 _tokenId, string _metadata) external onlyNonexistentToken(_tokenId) {
    ...
    // NOTE: perposfully doesn't trigger Transfer event
  }
}
