...
from toshieth.tasks import BaseEthServiceWorker
...
class MockTaskListener(BaseEthServiceWorker):
    def __init__(self):
        super().__init__([(MockTaskHandler, self)], queue_name="manager")
